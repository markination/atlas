...
if not os.getenv("IN_DOCKER"):
    # bcos if it is in docker, all env variables are set in github secrets and not in .env file to work with https://hackclub.app
    dotenv.load_dotenv()
...
class Bot(commands.AutoShardedBot):
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.CustomActivity("Atlas Testing"))
